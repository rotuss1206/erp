<div class="crm-document" style="background: #fff; overflow: hidden;">
    <div id="primary" class="file-primary content-area" v-show="tabShow === 'document'">
        <h2><?php _e( 'Documents', 'erp-document' ) ?></h2>
        <div class="list-table-wrap">
            <div class="list-table-inner">
                <div id="file_folder_wrapper" class="not-loaded">
                    ...
                    <div id="dir-file-operation-control" style="margin-top: 20px">
                    ...
                    <div id="checkbox_all">
                        <label class="header_caption header_caption_checkall"><input v-model="checkall" id="checkall" type="checkbox" @click="crmDocselectAll"><?php _e('Check All', 'wp-erp-doc');?></label>
                        ...
                        <ul id="file_folder_list">
                            <li v-for="d_data in dir_data" class="file_folder_list_item sr-{{$index}}" v-on:dblclick="renameNow('folder', $index)">
                                <div class="filename-col">
                                    <input type="checkbox" value="{{ d_data.dir_id }}" class="dir_file_chkbox dir_chkbox" v-model="dir_file_checkboxx" v-if="checkEditableDoc( d_data.user_id )">
