...
?><div class="wrap">
    <h2 class="report-title"><?php esc_attr_e( 'Member Report', 'erp' ); ?></h2>
    ...
    <table class="table widefat striped">
        <thead>
            <tr>
                ...
                <th><?php esc_attr_e( 'Trial Member', 'erp' ); ?></th>
                <th><?php esc_attr_e( 'Enquiry', 'erp' ); ?></th>
                <th><?php esc_attr_e( 'Member', 'erp' ); ?></th>
            </tr>
        </thead>
